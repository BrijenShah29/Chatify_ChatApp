...
class CallAdapter(val context: Context) : ListAdapter<CallModel, CallAdapter. CallListViewHolder>(DiffUtilCalls()) {

    inner class  CallListViewHolder(val binding : LayoutCallLogBinding) : RecyclerView.ViewHolder(binding.root){
        fun bind(
            item: CallModel,
            context: Context
        ) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int):  CallAdapter. CallListViewHolder {

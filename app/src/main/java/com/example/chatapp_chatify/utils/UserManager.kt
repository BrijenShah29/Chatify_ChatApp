...
class UserManager @Inject constructor(@ApplicationContext context: Context) {
    ...
    private var prefsOppositeUserName =
        context.getSharedPreferences(OPPOSITE_USER_NAME_FILE, Context.MODE_PRIVATE)
    private var prefsOppositeNumber =
        context.getSharedPreferences(OPPOSITE_USER_NUMBER_FILE, Context.MODE_PRIVATE)
    private var prefsOppositeUserImage =
        context.getSharedPreferences(OPPOSITE_USER_IMAGE_FILE, Context.MODE_PRIVATE)
    private var prefsOppositeUserId =
        context.getSharedPreferences(OPPOSITE_USER_ID_FILE, Context.MODE_PRIVATE)

    private var prefCurrentUserToken =
        context.getSharedPreferences(USER_TOKEN_FILE, Context.MODE_PRIVATE)
    ...
    fun getOppositeUserProfileImage(): String? {
        return prefsOppositeUserImage.getString(OPPOSITE_USER_IMAGE,
            Constant.OPPOSITE_USER_IMAGE_FILE)
    }
